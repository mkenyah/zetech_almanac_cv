...
#btnsup::-webkit-scrollbar-thumb:hover {
   ...
   text-align: center;
    ...
    /* Ensures spacing if placed next to another button */
}
...
<button type="button" class="btn btn-success" onclick="window.location.href='add_semester.php'">
    <i class="fa fa-plus"></i> Add Semester
</button>
                <!-- Print Button -->
                <a id="eventi" href='add_event.php?event_id={$event[' event_id']}' class='btn btn-success btn-sm'>Add Event</a>
                                    ...
                                    <?php foreach ($events as $event): 
                                        ...
                                        <tr>
                                            ...
                                            <td class="actions-column">
                                                <a href="new_event.php?event_id=<?php echo $event['id']; ?>" class="btn btn-success btn-sm">Edit</a>
                                             
                                                <a href="delete_event.php?event_id=<?php echo $event['id']; ?>&year=<?php echo isset($_GET['year']) ? (int)$_GET['year'] : date('Y'); ?>" 
